...
namespace Library_Management_System
{
    public partial class viewBook : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'libraryManagementSystemDataSet2.Book' table. You can move, or remove it, as needed.
            this.bookTableAdapter1.Fill(this.libraryManagementSystemDataSet2.Book);
            // TODO: This line of code loads data into the 'libraryManagementSystemDataSet1.Book' table. You can move, or remove it, as needed.
            this.bookTableAdapter.Fill(this.libraryManagementSystemDataSet1.Book);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string querry = "SELECT * FROM Book WHERE BookName = '" + txt_Name.Text + "'";
