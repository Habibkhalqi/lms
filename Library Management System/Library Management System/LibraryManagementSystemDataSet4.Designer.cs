...
namespace Library_Management_System {
    ...
    public partial class LibraryManagementSystemDataSet4 : global::System.Data.DataSet {
        ...
        public partial class studentDataTable : global::System.Data.TypedTableBase<studentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public studentRow AddstudentRow(string StudentID, string Name, string DOB, string Address, string Contact) {
...
namespace Library_Management_System.LibraryManagementSystemDataSet4TableAdapters {
    ...
    public partial class studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[student] ([StudentID], [Name], [DOB], [Address], [Contact]) VA" +
                "LUES (@StudentID, @Name, @DOB, @Address, @Contact);\r\nSELECT StudentID, Name, DOB" +
                ", Address, Contact FROM student WHERE (StudentID = @StudentID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[student] SET [StudentID] = @StudentID, [Name] = @Name, [DOB] = @DOB, [Address] = @Address, [Contact] = @Contact WHERE (([StudentID] = @Original_StudentID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_DOB = 1 AND [DOB] IS NULL) OR ([DOB] = @Original_DOB)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Contact = 1 AND [Contact] IS NULL) OR ([Contact] = @Original_Contact)));
SELECT StudentID, Name, DOB, Address, Contact FROM student WHERE (StudentID = @StudentID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, Name, DOB, Address, Contact FROM dbo.student";
        ...
        public virtual int Fill(LibraryManagementSystemDataSet4.studentDataTable dataTable) {
        ...
        public virtual LibraryManagementSystemDataSet4.studentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LibraryManagementSystemDataSet4.studentDataTable dataTable = new LibraryManagementSystemDataSet4.studentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LibraryManagementSystemDataSet4.studentDataTable dataTable) {
        ...
        public virtual int Delete(string Original_StudentID, string Original_Name, string Original_DOB, string Original_Address, string Original_Contact) {
        ...
        public virtual int Insert(string StudentID, string Name, string DOB, string Address, string Contact) {
            if ((StudentID == null)) {
        ...
        public virtual int Update(string StudentID, string Name, string DOB, string Address, string Contact, string Original_StudentID, string Original_Name, string Original_DOB, string Original_Address, string Original_Contact) {
            if ((StudentID == null)) {
                throw new global::System.ArgumentNullException("StudentID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string DOB, string Address, string Contact, string Original_StudentID, string Original_Name, string Original_DOB, string Original_Address, string Original_Contact) {
            return this.Update(Original_StudentID, Name, DOB, Address, Contact, Original_StudentID, Original_Name, Original_DOB, Original_Address, Original_Contact);
        }
    }
